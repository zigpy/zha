...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            None,
            "RealManf",
            "Generic Zigbee Coordinator (Silicon Labs EmberZNet: Elelabs, HUSBZB-1, Telegesis)",
            "RealManf Generic Zigbee Coordinator (Silicon Labs EmberZNet: Elelabs, HUSBZB-1, Telegesis)",
        ),
