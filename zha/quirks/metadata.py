"""ZHA quirk metadata model.

The declarative metadata produced by `zha.quirks.v2.QuirkBuilder`: exposed
entities, default-entity changes, alerts and naming, aggregated into a
`QuirkDefinition` stored on the compiled `Device` subclass.
"""
...
class QuirkDefinition:
    ...
    automation triggers, alerts and naming. Zigbee-level modifications live in
    `Device._zigpy_ops` instead.
    """
